...
public class SecurityAccess {
	...
	private static final String MESSAGE_UNDECLARED_USER = "Undeclared User. Use first SecurityAccess.login().with(USER)";
	...
	public SecurityAccess dashboard(User user) {
		...
		if (userLogged == null) {
			throw new IllegalArgumentException(MESSAGE_UNDECLARED_USER);
		}
